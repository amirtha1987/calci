...
var btnnumbers = createElements(
  "button",
  "btn-fluid btn-lightblue text-md-center text-sm-left text-xs-left p-md-3 p-sm-4 p-xs-4 col-2",
  10
);
...
function createButton(txt, val, fn) {
  ...
  a.setAttribute(
    "class",
    "btn-fluid btn-lightred text-md-center text-sm-left text-xs-left p-md-3 p-sm-4 p-xs-4 col-2"
  );
